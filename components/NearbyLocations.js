  ...
  class NearbyLocations extends Component {
    ...
    render() {
      ...
      if ((hasCameraPermission === null) && (location === null)) {
        return (
          <View style={{flex:1, backgroundColor: themeColor, justifyContent: 'center', alignItems: 'center'}}>
            <Text style={{fontSize: FONT_SIZE_LARGE, fontWeight: '200', color: '#fff', textAlign: 'center'}}>
              Please give us the permission to use your location camera!
            </Text>
          </View>
        )
        ...
        return (
          <View style={{flex:1, backgroundColor: themeColor, justifyContent: 'center', alignItems: 'center'}}>
            <Text style={{fontSize: FONT_SIZE_LARGE, fontWeight: '200', color: '#fff', textAlign: 'center'}}>
              Please give us the permission to use your camera!
            </Text>
          </View>
